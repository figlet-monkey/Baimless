...
bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        if (window->Collapsed)
        {
            ...
            RenderFrame((title_bar_rect.Min) / 10, title_bar_rect.Max / 10, title_bar_col, true, window_rounding);
        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoTitleBar))
            {
                ...
                window->DrawList->AddRectFilled(title_bar_rect.Min / 10, title_bar_rect.Max /10, title_bar_col, window_rounding, ImDrawCornerFlags_Top);
            }
